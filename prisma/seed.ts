import { PrismaClient, JenisMobil, EngineType, Role, BookingStatus } from '@prisma/client';
...
const generateCarImages = (mobilId: string) => {
    ...
    for (let i = 0; i < 2; i++) {
      ...
      await prisma.booking.create({
        data: {
          ...
          mobilImage: mainImage?.url || 'https://s1.bwallpapers.com/wallpapers/2014/07/27/mercedes-benz-cls63_113335529.jpg',
